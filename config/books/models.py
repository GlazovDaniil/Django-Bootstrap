...
class Author(models.Model):
    ...
    about = models.TextField(help_text="Введите сведенья об авторе",
                             verbose_name="Сведенья об авторе")
...
class Book(models.Model):
    ...
    publisher = models.ForeignKey('Publisher', on_delete=models.CASCADE,
                                  help_text="Выберите издатльство",
                                  verbose_name="Издатльство", null=True)
    year = models.CharField(max_length=4,
                            help_text="Введите год издания",
                            verbose_name="Год издания")
    author = models.ManyToManyField("Author",
                                    help_text="Выберите автора(ов) книги",
                                    verbose_name="Автор(ы) книги")
    summary = models.TextField(max_length=1000,
                               help_text="Введите крадкое описание книги",
                               verbose_name="Крадкое описание книги")
...
class BookInstance(models.Model):
    ...
    status = models.ForeignKey('Status', on_delete=models.CASCADE, null=True,
                               ...
                               verbose_name="Состояние экземпляра книги")
